          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                Hey there! You're invited to join a ManageWise Workspace!
              </CardTitle>
              <CardDescription>
                Looks like you need to be logged into your ManageWise account to
                join this Workspace.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div>
                  {user ? (
                    <div className="flex items-center justify-center my-3">
                      <form onSubmit={handleSubmit}>
                        <Button
                          type="submit"
                          disabled={isLoading}
                          className="!bg-black !text-white text-[23px] !h-auto"
                        >
                          {isLoading && (
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-2">
                      <Link className="flex-1 w-full text-base" to={`/sign-up`}>
